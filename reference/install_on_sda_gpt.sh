#!/bin/bash
# Copyright (c) 2015-16 sakaki <sakaki@deciban.com>
# License: GPL 3.0+
# NO WARRANTY
#
# Installs RedSleeve system on /dev/sda, using default settings.
...
# this is the current copy of the kernel...
...
# this is the (sourced) script that will kexec that kernel...
