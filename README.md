...
* The workaround for the [Marvell tso issue](http://forum.excito.com/viewtopic.php?f=7&t=5738) has been implemented, again via a `udev` rule (see `/etc/udev/rules.d/50-marvell-fix-tso.rules`).
